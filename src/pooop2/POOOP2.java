...
public class POOOP2 {
    ...
    public static void main(String[] args) {
        ...
        // Imprime un saludo de error en la consola
       ...
       /**
     * Compara dos números para determinar cuál es menor.
     *
     * @param x Primer número a comparar.
     * @param y Segundo número a comparar.
